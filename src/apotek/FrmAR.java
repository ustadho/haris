...
//            }
    ...
    private void txtCustomerKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtCustomerKeyReleased
        fn.lookup(evt, new Object[]{txtNamaCustomer}, 
                        "select kode_pelanggan, nama_pelanggan, coalesce(alamat,'') as alamat\n" +
                        "from pelanggan where kode_pelanggan || nama_pelanggan || coalesce(alamat,'') "
                        + "ilike '%"+txtCustomer.getText()+"%'\n" +
                "order by 2", 500, 200);
